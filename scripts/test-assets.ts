...
export const downloadableTestAssets: DownloadableTestAsset[] = [
  ...
  {
    id: "kicad-keepout-ascii",
    relativePath: "kicad/keepout-test.asc",
    format: "ascii",
    expectedByteLength: 861,
    gitBlobSha: "3c8b85cd3b4c0cc391e5ca27410f1270cb442d7e",
    downloadUrl: `${KICAD_RAW_ROOT}/${PADS_FIXTURE_PATH}/keepout_test.asc`,
    sourceUrl: `${KICAD_BLOB_ROOT}/${PADS_FIXTURE_PATH}/keepout_test.asc`,
    licenseUrl: `${KICAD_BLOB_ROOT}/LICENSE`,
  },
  {
  ...
  },
  {
    ...
    format: "ascii",
    expectedByteLength: 701,
    gitBlobSha: "45f66983f0f3cb50e953a3f0705b8d67c5377d2e",
    downloadUrl: `${KICAD_RAW_ROOT}/${PADS_FIXTURE_PATH}/synthetic_noncopper_track.asc`,
    sourceUrl: `${KICAD_BLOB_ROOT}/${PADS_FIXTURE_PATH}/synthetic_noncopper_track.asc`,
    licenseUrl: `${KICAD_BLOB_ROOT}/LICENSE`,
  },
  {
  ...
  {
    id: "kicad-dexter-motor-control-ascii",
    relativePath: "kicad/dexter-motor-control.asc",
    format: "ascii",
    expectedByteLength: 936754,
    gitBlobSha: "a095b6257cb6977a2f6eb0b9421c261e425accec",
    downloadUrl: `${KICAD_RAW_ROOT}/${PADS_FIXTURE_PATH}/Dexter_MotorCtrl/Dexter_MotorCtrl.asc`,
    sourceUrl: `${KICAD_BLOB_ROOT}/${PADS_FIXTURE_PATH}/Dexter_MotorCtrl/Dexter_MotorCtrl.asc`,
  ...
  {
    id: "kicad-ems4-rev2-ascii",
    relativePath: "kicad/ems4-rev2.asc",
    format: "ascii",
    expectedByteLength: 1_028_182,
    gitBlobSha: "40e2b34db4db74783b27ebd0e36dbcc98bc0f76e",
    downloadUrl: `${KICAD_RAW_ROOT}/${PADS_FIXTURE_PATH}/Ems4_Rev2/Ems4_Rev2.asc`,
    sourceUrl: `${KICAD_BLOB_ROOT}/${PADS_FIXTURE_PATH}/Ems4_Rev2/Ems4_Rev2.asc`,
  ...
  {
    id: "kicad-tms1mmx19-ascii",
    relativePath: "kicad/tms1mmx19.asc",
    format: "ascii",
    expectedByteLength: 651_519,
    gitBlobSha: "7cc06dd3ae8962c518b59a4c1bb69c53d921bab7",
    downloadUrl: `${KICAD_RAW_ROOT}/${PADS_FIXTURE_PATH}/TMS1mmX19/TMS1mmX19.asc`,
    sourceUrl: `${KICAD_BLOB_ROOT}/${PADS_FIXTURE_PATH}/TMS1mmX19/TMS1mmX19.asc`,
